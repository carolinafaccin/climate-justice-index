...
@media (max-width: 900px) {
  ...
  /* Hamburger button (top-left, always visible on mobile) */
  #menu-toggle {
    display: flex !important;
    position: fixed; top: 0.7rem; left: 0.7rem; z-index: 1100;
    width: 42px; height: 42px;
  ...
  #menu-toggle span {
    ...
    background: #fff; margin: 2px 0; border-radius: 1px;
  }

  /* Main content full width */
  #content { margin-left: 0; }

  /* Pages: reduce padding, no max-width */
  .page { padding: 1.5rem 1rem; max-width: none; }

  /* Cover */
  .cover-page { padding: 4.5rem 1rem 2rem; min-height: auto; }
  .cover-page h1 { font-size: 1.8rem; line-height: 1.25; }
  .cover-subtitle { font-size: 0.95rem; }
  .cover-meta { font-size: 0.8rem; margin-bottom: 1.5rem; }

  /* City header */
  .city-header-page { padding: 4.5rem 1rem 1.5rem; min-height: auto; }
  .city-header-page h1 { font-size: 1.6rem; }
  .city-quick-stats { gap: 1.2rem; }
  .stat-value { font-size: 1.35rem; }
  .stat-label { font-size: 10px; }

  /* Section titles */
  h1.section-title { font-size: 1.35rem; margin-bottom: 1rem; }
  h2.section-title { font-size: 1.1rem; margin-bottom: 1rem; }

  /* Intro */
  .intro-text p { font-size: 0.9rem; }

  /* Dim cards: stack vertically */
  .dim-cards { grid-template-columns: 1fr; gap: 0.7rem; }

  /* Dim score bar: compact */
  .dim-score-bar {
    gap: 0.75rem; font-size: 0.82rem; padding: 0.55rem 0.8rem;
    flex-direction: column; align-items: flex-start;
  }

  /* Indicator block: cleaner header */
  .ind-header { font-size: 0.85rem; gap: 0.5rem; }
  .ind-label { font-size: 0.9rem; }
  .ind-means {
    margin-left: 0; width: 100%; font-size: 10.5px;
    padding-top: 0.2rem;
  }
  ...
  .sidebar-pdf { padding: 0.7rem 0.9rem; }

  /* Notas: tighter spacing */
  .notes-body h1 { font-size: 1.15rem; }
  .notes-body h2 { font-size: 0.95rem; }
  .notes-body p, .notes-body li { font-size: 0.85rem; }
  .notes-body table { font-size: 0.78rem; }
  .notes-body th, .notes-body td { padding: 0.35rem 0.5rem; }
}

/* Extra-narrow (phones) */
@media (max-width: 480px) {
  .page { padding: 1.25rem 0.85rem; }
  .cover-page h1 { font-size: 1.55rem; }
  .city-header-page h1 { font-size: 1.4rem; }
  .city-quick-stats { gap: 0.9rem 1.2rem; }
...
@media print {
  ...
  /* Each dimension starts on a new page (avoid orphaned dim headers) */
  .dim-section { break-before: page; }
...
.notes-body h3 { font-size: 0.9rem; font-weight: 700; color: var(--dark); margin: 1.2rem 0 0.4rem; }
...
.cluster-map img { width: 100%; max-width: 560px; height: auto; display: block; margin: 0 auto; border-radius: 6px; border: 1px solid var(--border); }
