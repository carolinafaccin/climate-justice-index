...
1. **Paulo (MIR)** apontou que calor afeta áreas urbanas e rurais de formas distintas — risco de viés se a metodologia privilegiar uma escala.
1. A ONU-Habitat sugere apresentar a mudança como **anomalia** (diferença em relação à média histórica), capturando onde o calor foge do padrão local — abordagem que isola o sinal de mudança climática do clima naturalmente quente da região.
