...
A primeira implementação seguiu os limiares utilizados para o Vale do Taquari/RS, classificando declividade em % slope sobre o Copernicus GLO-30 DEM em faixas Alta (35–60%), Média (25–35% e 60–75%), Baixa e Sem. Uma validação cruzada nacional contra o NASA LHASA revelou **correlação negativa** entre os dois métodos:
...
- **Slope puro com limiares para o Vale do Taquari (descartado)**: simples e usa DEM Copernicus aberto, mas calibração regional não generaliza; correlação negativa nacional contra LHASA é evidência forte de inadequação. Preservado em `etl/discarded/` para referência histórica e auditoria.
