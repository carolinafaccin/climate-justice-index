...
2. **Inadequação conceitual** — variável não tem aderência teórica com as dimensões do IIC.
3. **Lacunas de cobertura territorial** — base não cobre todos os 5.570 municípios.
4. **Insuficiência de granularidade** — não há dado na escala intramunicipal (apenas municipal ou estadual).
5. **Ausência de fonte confiável** — não há base oficial nem sistematização nacional do fenômeno.
6. **Inviabilidade operacional** — complexidade de cálculo ou esforço de limpeza/geocodificação excede recursos técnicos do projeto.
7. **Baixa qualidade ou confiabilidade** — campos vazios, erros de preenchimento ou ruído alto a ponto de comprometer validade estatística.
8. **Redundância estatística** — variável mensura algo já capturado por outra mais robusta.
9. **Defasagem temporal** — última atualização é antiga e não reflete a realidade atual.
