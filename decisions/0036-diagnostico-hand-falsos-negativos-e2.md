...
1. **O parquet E2 não preserva HAND bruto** — só armazena o score já classificado
   ...
   teto HAND ideal.
1. **A intuição empírica é heterogênea entre regiões** — S e SE concentram
...
- [h3_e2_fn_hand_diagnostic_gee.js](../etl/discarded/h3_e2_fn_hand_diagnostic_gee.js) — diagnóstico HAND no GEE (movido para discarded)
- [07_sgb_analyse_fn_hand.py](../etl/discarded/07_sgb_analyse_fn_hand.py) — análise local (movido para discarded)
...
- [ADR-0039](0039-e2-mapbiomas-com-overlay-sgb.md) — decisão final: MapBiomas + overlay SGB
