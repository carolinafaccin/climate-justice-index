...
2. **Validação de e2**: identificar falsos negativos — hexágonos onde o SGB aponta alta suscetibilidade a inundação mas `flood_score < 0,1` — e analisar a distribuição de HAND nesses casos para avaliar se o teto de 6 m precisa ser revisto.
