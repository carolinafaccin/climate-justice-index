...
## Status
Accepted — 2026-05-19. Implementação preservada em `archive/v6_areas_verdes.py` e `archive/h3_areas_verdes_ndvi_gee.js`.
...
## Decisão
**Não incluir v6 (NDVI áreas verdes) na dimensão IV.** O conteúdo é preservado em `archive/`.
...
- [archive/v6_areas_verdes.py](../archive/v6_areas_verdes.py) — ETL preservado.
- [archive/h3_areas_verdes_ndvi_gee.js](../archive/h3_areas_verdes_ndvi_gee.js) — script GEE preservado.
