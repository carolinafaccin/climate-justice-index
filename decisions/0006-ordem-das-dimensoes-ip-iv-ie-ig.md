...
2. **IV — Como vivem?** Condições materiais e iniquidades estruturais.
3. **IE — Qual o gatilho climático?** Ameaça física como agravante de uma situação preexistente.
4. **IG — Qual a resposta do Estado?** Capacidade institucional do município.
